  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 offset-md-2 col-sm-12 offset-sm-0 overflow-hidden">
        ...
        <h3 class="text-center"><?php esc_html_e( 'Not what you are looking for?', 'bootstrapWP' ); ?></h3>

        <div class="button-box text-center">
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="btn btn-primary"><?php esc_html_e( 'Back to Safety', 'bootstrapWP' ); ?></a>
        </div>
